import avatarImage from '../imagenes/yo.jpg';

export function Avatar() {
  return (
    <div className="flex items-center ml-4 mt-4">
      <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-full overflow-hidden">
        <a href="mailto:javi.martin.montes@gmail.com" ><img src={avatarImage} alt="Avatar" className="object-cover w-full h-full" /></a>
      </div>
